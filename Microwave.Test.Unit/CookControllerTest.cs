...
namespace Microwave.Test.Unit
{
   ...
   public class CookControllerTest
   {
      ...
      [Test]
      public void AddTime_1Called_CorrectTimeAdded()
      {
         uut.StartCooking(50, 60);
         uut.AddTime(30);

         timer.TimeRemaining.Returns(90);
      }

      [Test]
      public void AddTime_3Called_CorrectTimeAdded()
      {
         uut.StartCooking(50, 60);
         for (int i = 0; i < 3; i++)
         {
      ...
      [Test]
      public void ReduceTime_CorrectTimeAdded()
      {
